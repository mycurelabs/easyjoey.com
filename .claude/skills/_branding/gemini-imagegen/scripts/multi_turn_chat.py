...
def main():
    ...
    while True:
        ...
        try:
            ...
            separator = "━" * 50
            print(f"\n{'='*50}")
            print("ERROR: API Quota Exhausted")
            print(f"{'='*50}")
            print(f"\nYour prompt:")
            print(separator)
            print(user_input)
            ...
            print("2. Copy your prompt above and paste it")
            if chat.current_image:
                print("3. Upload your current image if editing")
            print("4. The web interface has a SEPARATE quota from the API")
            print("\nNote: You can continue in the web interface.")
            print("Check API usage: https://ai.dev/usage?tab=rate-limit")
            print(f"\n{'='*50}\n")
