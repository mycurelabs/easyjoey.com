...
def format_quota_error(instruction: str, input_path: str) -> str:
    """Format a user-friendly quota exhaustion message with fallback instructions.

    Args:
        instruction: The edit instruction that couldn't be processed
        input_path: Path to the input image
...
2. Upload your image: {input_path}
3. Paste the instruction above in the chat
...
def main():
    ...
    try:
        ...
        print(format_quota_error(args.instruction, args.input), file=sys.stderr)
        sys.exit(429)
