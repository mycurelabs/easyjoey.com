...
When you encounter a `ResourceExhausted` or `429` error, it means your API quota limit has been reached. **Important**: The Gemini web interface ([gemini.google.com](https://gemini.google.com)) and the API have **separate quota systems**.

#### Fallback Workflow

When API quota is exhausted, all scripts will automatically display your optimized prompt in a copy-friendly format:
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Character sheet design. Professional cartoon illustration...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

Fallback Instructions:
1. Visit https://gemini.google.com
2. Copy the prompt above and paste it in the web interface
3. For image editing: Upload your input image
...
- **API quota**: Limited for programmatic access, resets daily
- **Web interface quota**: More generous, designed for human interaction
- **Same account, different buckets**: Exhausting one doesn't affect the other

#### Script Behavior

All scripts (`generate_image.py`, `edit_image.py`, `multi_turn_chat.py`, `compose_images.py`) handle quota errors gracefully:

- Exit with status code `429` (instead of generic `1`)
- Display your full prompt/instruction
- List any input images involved
- Provide step-by-step fallback instructions

#### Prevention

Monitor your API usage at [https://ai.dev/usage?tab=rate-limit](https://ai.dev/usage?tab=rate-limit) to track:
- Requests per day/minute limits
- Token consumption
